...
hero:
  ...
  image:
    file: ../../assets/images/readscore_logo.svg
  actions:
    - text: Get Started
      link: /readscore/metrics/
      icon: right-arrow
    - text: Choose a Metric
      link: /readscore/choosing-a-metric/
      icon: list-format
    - text: GitHub
      link: https://github.com/plainlicense/readscore
      icon: external
      variant: minimal
---
...
readscore defaults to a minimum of 100 words. Passing shorter text raises a `ValueError`. You can lower the threshold with `Readability(text, min_words=50)`, but scores become less reliable on short texts. SMOG also requires at least 30 sentences.
:::
...
<LinkCard
  ...
  href="/readscore/choosing-a-metric/"
/>

## Built for plain language work

readscore is the scoring engine behind [Plain License](https://plainlicense.org/) tools, including the in-development [plainr](https://github.com/plainlicense/plainr) CLI. It is designed to run in CI pipelines, scripts, and anywhere Python runs.
