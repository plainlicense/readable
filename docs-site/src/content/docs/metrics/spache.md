...
[Dale-Chall](/readable/metrics/dale-chall/) for text above grade 3.
:::
...
- You want to check whether a **children's health or safety document** is appropriate for
  early readers.
- You are using Spache alongside [Dale-Chall](/readable/metrics/dale-chall/) to assess
...
[Dale-Chall](/readable/metrics/dale-chall/) instead.
...
- [Dale-Chall Readability Formula](/readable/metrics/dale-chall/) — same word-list
