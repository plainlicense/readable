...
- You need to check text aimed at **grade 4 and above**. For younger readers (grades 1–3),
  use [Spache](/readable/metrics/spache/) instead.
...
- **Not appropriate for grades 1–3.** The formula's lowest score band covers grades 1–4
  ...
  grade 1 and one appropriate for grade 4. Use [Spache](/readable/metrics/spache/) for
  primary-grade text.
...
- [Spache Readability Formula](/readable/metrics/spache/) — same word-list approach,
